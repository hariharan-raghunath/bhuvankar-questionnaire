            ...
            <div className="flex justify-between mt-8 pt-6 border-t border-gray-200">
              ...
              {step < 3 ? (
                ...
                <button
                  ...
                  disabled={loading}
                  className="flex items-center px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-medium ml-auto disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-green-400"
                >
                  {loading ? (
                    <>
